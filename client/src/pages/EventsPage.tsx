...
const events: WeddingEvent[] = [
  {
    ...
    description: 'Join us as we kick off our wedding weekend! Enjoy tropical cocktails, delicious appetizers, and the beautiful Cancun sunset with a bonfire on the beach. This is a casual affair to reconnect with family and friends before the festivities begin.',
    stampTheme: 'beach',
  },
  {
    id: 'haldi',
    ...
    description: 'A pre-wedding ritual where turmeric paste is applied to the bride and groom for blessings of prosperity. Wear clothes you don\'t mind getting messy/wet - it\'s part of the fun!',
    stampTheme: 'haldi',
  },
  {
    id: 'mehndi',
