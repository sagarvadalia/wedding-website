      ...
      <Section>
        ...
        >
          <p className="text-lg text-sand-dark leading-relaxed">
            ...
            The first - back in November 2014, as two wide-eyed college freshmen who were still learning and growing in life, and the second - June 2021, as two 25-year-olds making our mark in the working adult world. Why were our &ldquo;first&rdquo; dates 7 years apart? Well, it&rsquo;s a beautiful story that portrays how the &ldquo;ones that got away&rdquo; eventually come back when the time is right. We are excited to share our story with you, and we hope you enjoy it as much as we cherish it every day.
          </p>
        </motion.div>

        {/* Timeline */}
        {isDesktop ? (
          <DesktopTimeline events={timeline} />
        ) : (
